export const stateData = {
    ...
    "Andhra Pradesh": [
      ...
      "Kadapa", "Karimnagar", "Khammam", "Krishna", "Kurnool", "Mahbubnagar", 
    ...
    "Arunachal Pradesh": [
      ...
      "Longding", "Lower Dibang Valley", "Lower Subansiri", "Papum Pare", "Tawang", 
    ...
    Assam: [
      ...
      "Jorhat", "Kamrup Metropolitan", "Kamrup", "Karbi Anglong", "Karimganj", 
      "Kokrajhar", "Lakhimpur", "Morigaon", "Nagaon", "Nalbari", "Sivasagar", 
    ...
    Delhi: [
      "Central 11", "East 11", "New 11", "North 11", "North East", "North West 11", 
      "South 11", "South West 11", "West 11"
    ],
    Goa: ["North 12", "South 12"],
    Gujarat: [
      "Ahmedabad", "Amreli District", "Anand", "Banaskantha", "Bharuch", "Bhavnagar", 
      "Dahod", "Dang", "Gandhinagar", "Jamnagar", "Junagadh", "Kheda", "Kutch", 
      "Mehsana", "Narmada", "Navsari", "Panchmahal", "Patan", "Porbandar", "Rajkot", 
    ...
    "Jammu and Kashmir": [
      "Kathua District", "Anantnag District", "Bandipora District", "Baramulla District", 
      "Budgam District", "Doda District", "Ganderbal District", "Jammu District", 
      "Kargil District", "Kishtwar District", "Kulgam District", "Kupwara District", 
      "Leh District", "Poonch District", "Pulwama District", "Rajouri District", 
      "Ramban District", "Reasi District", "Samba District", "Shopian District", 
      "Srinagar District", "Udhampur District"
    ],
    Jharkhand: [
      "Bokaro", "Chatra", "Deoghar", "Dhanbad", "Dumka", "Garhwa", "Giridih", "Godda", 
      "Gumla", "Hazaribagh", "Jamtara", "Khunti", "Kodarma", "Latehar", "Lohardaga", 
      "Pakur", "Palamu", "Pashchimi Singhbhum", "Purbi Singhbhum", "Ramgarh", "Ranchi", 
    ...
    Karnataka: [
      ...
      "Ramanagara", "Shimoga", "Tumakuru", "Udupi", "Uttara Kannada", "Yadgir"
    ],
    Kerala: [
    ...
    "Madhya Pradesh": [
      ...
      "Bhopal", "Bhurhanpur", "Chhatarpur", "Chhindwara", "Damoh", "Datia", "Dewas", 
      "Dhar", "Dindori", "Guna", "Gwalior", "Harda", "Hoshangabad", "Indore", 
      "Jabalpur", "Jhabua", "Katni", "Khandwa (East Nimari)", "Khargone (West Nimari)", 
    ...
    Meghalaya: [
      "Baghmara", "Jowai/Khliehriat", "Nongpoh", "Nongstoin/Mawkyrwat", "Shillong", 
      "Tura/Ampati", "Williamnagar/Resubelpara"
    ],
    Mizoram: [
    ...
    Nagaland: [
      "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon", "Piren", 
      "Phek", "Tuensang", "Wokha", "Zunheboto"
    ],
    Odisha: [
      "Angul (Anugul)", "Baleswar (Balasore)", "Bargarh (Baragarh)", "Bhadrak", 
      "Bolangir (Balangir)", "Boudh (Bauda)", "Cuttack", "Debagarh (Deogarh)", 
      "Dhenkanal", "Gajapati", "Ganjam", "Jagatsinghpur", "Jajapur (Jajpur)", 
    ...
    Punjab: [
      "Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilika", 
      "Firozpur", "Gurdaspur", "Hoshiarpur", "Jalandhar", "Kapurthala", "Ludhiana", 
      "Mansa", "Moga", "Mohali", "Muktasar", "Pathankot", "Patiala", "Rupnagar", 
    ...
    "Tamil Nadu": [
      "Alandur", "Ariyalur", "Chennai", "Coimbatore", "Cuddalore", "Dharmapuri", 
      "Dindigul", "Erode", "Kanchipuram", "Kanniyakumari", "Karur", "Krishnagiri", 
      "Madurai", "Nagapattinam", "Namakkal", "Nilgiris", "Perambular", "Pudukkottai", 
      "Ramnathapuram", "Salem", "Sivaganga", "Thanjavur", "Theni District", 
      "Thoothukodi District", "Tiruchirappalli", "Tirunelveli", "Tiruppur", 
      "Tiruvallur", "Tiruvannamalai", "Tiruvarur", "Vellore", "Villupuram", 
      "Virudhnagar"
    ],
    Telangana: [
      "Adilabad", "Hyderabad", "Jagtial", "Jogulamba", "Karimnagar", "Khammam", 
      "Komaram Bheem", "Medak", "Nagarkurnool", "Nalgonda", "Nizamabad", "Wanaparthy"
    ],
    Tripura: [
    ...
    "Uttar Pradesh": [
      "Agra", "Aligarh", "Allahabad", "Ambedkar Nagar", "Amethi", "Auraiya", 
      ...
      "Gorakhpur", "Hamirpur", "Hapur", "Hardoi", "Jalaun", "Jaunpur", "Jhansi", 
      "Jyotiba Phule Nagar", "Kannauj", "Kanpur Dehat", "Kanpur Nagar", "Kasganj", 
      "Kaushambi", "Kushinagar", "Lakhimpur-Kheri", "Lalitpur", "Lucknow", "Hathras", 
      "Mahoba", "Mahrajganj", "Mainpuri", "Mathura", "Mau", "Meerut", "Mirzapur", 
      "Moradabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", "Rae Bareli", "Rampur", 
      "Saharanpur", "Sambhal", "Sant Kabir Nagar", "Sant Ravidas Nagar (Bhadohi)", 
    ...
    "West Bengal": [
      "Bankura", "Bardhaman", "Birbhum", "Cooch Behar", "Darjeeling", "East Midnapore", 
      "Hooghly", "Howrah", "Jalpaiguri", "Kolkata", "Malda", "Murshidabad", "Nadia", 
      "North 24 Parganas", "North Dinajpur", "Purulia", "South 24 Parganas", 
  ...
  export const getAllStates = () => Object.keys(stateData);
  
  export const getCitiesForState = (state) => stateData[state] || [];
