  ...
  const enrollmentCategories = [
    {
      icon: Briefcase,
      description:
        "Working professionals seeking to advance into senior management and C-suite positions",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: Lightbulb,
      description:
        "Entrepreneurs who want to develop business acumen and strategic thinking skills",
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: TrendingUp,
      description:
        "Mid-career professionals looking to switch industries or functional areas",
      gradient: "from-green-500 to-emerald-500",
    },
    {
      icon: GraduationCap,
      description:
        "Fresh graduates ready to build a strong foundation in business management",
      gradient: "from-orange-500 to-red-500",
    },
  ];

  return (
    <section className="py-10 sm:py-20 px-4 bg-gradient-to-br from-slate-50 via-white to-slate-100">
