      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 py-6 lg:py-0 lg:min-h-[calc(100vh-72px)] lg:flex lg:items-center">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center w-full">
          ...
          <div className="w-full lg:w-7/12 space-y-4 lg:space-y-8 text-center lg:text-left">
            {/* Ranking Badge */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400/20 to-orange-500/20 backdrop-blur-sm border border-yellow-400/30 text-yellow-300 px-3 py-2 lg:px-4 lg:py-2 rounded-full text-xs lg:text-sm font-semibold">
              <Star className="w-3 h-3 lg:w-4 lg:h-4 fill-current" />
              <span>QS Ranked #1 Online MBA in India</span>
            </div>
            ...
            <div className="space-y-2 lg:space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 lg:gap-3 text-sm sm:text-base lg:text-xl xl:text-2xl text-gray-200">
                <Award className="w-4 h-4 lg:w-6 lg:h-6 text-green-400 flex-shrink-0" />
                <span className="text-center lg:text-left">
                  Top 10 in Asia Pacific • Amity University Online
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 lg:gap-4 text-white max-w-md mx-auto lg:max-w-none lg:mx-0">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2">
                ...
                <span className="text-xs lg:text-base">Personal AI Tutor</span>
              </div>
              <div className="flex items-center justify-center lg:justify-start gap-2">
                <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 bg-purple-400 rounded-full flex-shrink-0"></div>
                <span className="text-xs lg:text-base">400+ Hours Content</span>
              </div>
              <div className="flex items-center justify-center lg:justify-start gap-2">
                <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 bg-orange-400 rounded-full flex-shrink-0"></div>
                <span className="text-xs lg:text-base">1.6 Lac+ Alumni</span>
              </div>
            </div>
                        ...
                        <select
                          ...
                          className={`w-full px-3 py-2 lg:px-4 lg:py-3 bg-white/10 border ${
                            errors[field.name]
                              ? "border-red-400"
                              : "border-white/20"
                          } rounded-lg lg:rounded-xl text-white text-sm lg:text-base focus:outline-none focus:ring-1 focus:ring-green-400/50 focus:border-green-400/50 transition-all duration-300`}
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 lg:px-4 lg:py-3 bg-white/10 border ${
                            errors[field.name]
                              ? "border-red-400"
                              : "border-white/20"
                          } rounded-lg lg:rounded-xl text-white placeholder-gray-300 text-sm lg:text-base focus:outline-none focus:ring-1 focus:ring-green-400/50 focus:border-green-400/50 transition-all duration-300`}
                          required={field.required}
                          onBlur={
