...
const EducationIllustration = () => (
  <div className="relative">
    <svg viewBox="0 0 500 400" className="w-full h-auto">
      ...
      <circle cx="400" cy="120" r="25" fill="#3b82f6" opacity="0.2" />
      <circle cx="380" cy="250" r="20" fill="#8b5cf6" opacity="0.2" />
  ...
  const hallmarks = [
    {
      ...
      description:
        "Chandigarh University is the youngest private university to receive NAAC A++ in the first cycle.",
      icon: "university",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    ...
    {
      id: 2,
      title: "Global Recognition & Digital Learning",
      description:
        "Our UGC-recognized degree is combined with state-of-the-art digital learning tools for an immersive experience.",
      icon: "diploma",
    ...
    },
    {
      ...
      description:
        "Focus on real-world business challenges through case studies, live projects, and industry exposure.",
      icon: "industry",
    ...
    },
    {
      ...
      description:
        "Balance work or personal commitments with a flexible, affordable program without geographical constraints.",
      icon: "clock",
    ...
    {
      id: 5,
      title: "AI-Proctored Online Exams",
      description:
        "Secure exams with AI-proctored systems, allowing you to take tests from anywhere at your convenience.",
      icon: "exam",
      color: "text-cyan-600",
      bgColor: "bg-cyan-100",
    ...
    },
    {
      ...
      description:
        "Connect with industry leaders, faculty mentors, and peers to build a strong professional network.",
      icon: "curriculum",
      color: "text-teal-600",
      bgColor: "bg-teal-100",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our Online MBA offers a flexible and industry-aligned education
