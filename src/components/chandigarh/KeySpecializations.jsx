      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-16">
          ...
          <p className="text-lg text-blue-100 max-w-2xl mx-auto">
            ...
            business leaders at Chandigarh University
          </p>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Active Pulse Ring */}
        {isActive && (
          <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-3xl animate-pulse" />
        )}
        ...
        {/* Selection Indicator */}
        {isActive && (
          <div className="absolute top-4 right-4 w-3 h-3 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full border-2 border-white shadow-lg animate-pulse" />
        )}
  ...
  return (
    <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
      ...
      <div className="relative mb-8">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 rounded-2xl -m-4" />
